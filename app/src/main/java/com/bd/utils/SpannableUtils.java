...
public class SpannableUtils {
    public static void color(@NonNull Spannable spannableText, @NonNull String textToHighlight, int color) {
        String text =  spannableText.toString().toLowerCase();
        int begin = text.indexOf(textToHighlight.toLowerCase());
        while (begin >= 0) {
            ...
            begin = text.indexOf(textToHighlight.toLowerCase(), begin + textToHighlight.length());
        }
    }
}
